...
func init() {
	...
	downloadCmd.Flags().StringVarP(&formatFlag, "format", "f", "json", "Output format: 'json', 'csv' or 'parquet'")
...
func executeDownload() {
	...
	default:
		log.Fatalf("Unknown output format %q: use 'json', 'csv' or 'parquet'", formatFlag)
	}
